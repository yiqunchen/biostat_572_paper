...
with open('./chen_data.pkl', 'rb') as fp:
...
spike_sigma = 0.986
#### fix name
test_result = cv_select_lambda(y= detected_fluo,s_vec=time_spike,t_vec=time_fluo,                   lambda_seq = lambda_choice ,L_min_seq = L_seq,\
                   gamma =spike_sigma)
...
with open(output_dir+'chen_40s_extensive_lambda_data.pkl', 'wb') as handle:
